...
KB_MATRIX_LAYER(
  ...
  KEY_Mute,       KEY_q_Q, KEY_q_Q,       KEY_q_Q,        KEY_q_Q,     KEY_q_Q, 1,
  KEY_VolumeUp,   KEY_q_Q, KEY_q_Q,       KEY_q_Q,        KEY_q_Q,     KEY_q_Q,
  KEY_VolumeDown, KEY_q_Q, KEY_q_Q,       KEY_q_Q,        KEY_q_Q,     KEY_q_Q, 2,
  KEY_q_Q,        KEY_q_Q, KEY_LeftArrow, KEY_RightArrow, KEY_LeftGUI,
                                                     KEY_LeftControl, KEY_LeftAlt,
                                                0,                 0,    KEY_Home,
                              KEY_DeleteBackspace, KEY_DeleteForward,     KEY_End,
  // right hand
  ...
  KEYPAD_0_Insert,      KEYPAD_1_End,       KEYPAD_2_DownArrow, KEYPAD_3_PageDown,   KEY_q_Q,       KEY_q_Q, KEYPAD_Minus,
                                            KEY_RightGUI,       KEY_UpArrow,         KEY_DownArrow, KEY_q_Q, KEY_q_Q,
  KEY_LeftAlt,  KEY_LeftControl,
  KEY_PageUp,   0,               0,
  KEY_PageDown, KEY_ReturnEnter, KEY_Spacebar
),
...
KB_MATRIX_LAYER(
  ...
  4,       KEY_a_A, KEY_a_A,       KEY_a_A,        KEY_a_A,     KEY_a_A, 1,
  5,       KEY_a_A, KEY_a_A,       KEY_a_A,        KEY_a_A,     KEY_a_A,
  6,       KEY_a_A, KEY_a_A,       KEY_a_A,        KEY_a_A,     KEY_a_A, 2,
  KEY_a_A, KEY_a_A, KEY_LeftArrow, KEY_RightArrow, KEY_LeftGUI,
                                              KEY_LeftControl, KEY_LeftAlt,
                                         0,                 0,    KEY_Home,
                       KEY_DeleteBackspace, KEY_DeleteForward,     KEY_End,
  // right hand
  ...
  KEY_a_A,      KEY_a_A, KEY_a_A,      KEY_a_A,       KEY_a_A,       KEY_a_A, KEY_F24,
                         KEY_RightGUI, KEY_UpArrow,   KEY_DownArrow, KEY_a_A, KEY_a_A,
  KEY_LeftAlt,  KEY_LeftControl,
  KEY_PageUp,   0,               0,
  KEY_PageDown, KEY_ReturnEnter, KEY_Spacebar
),
...
KB_MATRIX_LAYER(
  ...
  // left hand
  KEY_GraveAccent_Tilde, KEY_1_Exclamation,           KEY_2_At,           KEY_3_Pound,            KEY_4_Dollar, KEY_5_Percent, 0,
  KEY_Tab,               KEY_SingleQuote_DoubleQuote, KEY_Comma_LessThan, KEY_Period_GreaterThan, KEY_p_P,      KEY_y_Y,       1,
  KEY_Escape,            KEY_a_A,                     KEY_o_O,            KEY_e_E,                KEY_u_U,      KEY_i_I,
  KEY_LeftShift,         KEY_Semicolon_Colon,         KEY_q_Q,            KEY_j_J,                KEY_k_K,      KEY_x_X,       2,
  0x2F,                  0x30,                        KEY_LeftArrow,      KEY_RightArrow,         KEY_LeftGUI,
                                                                                                    KEY_LeftControl, KEY_LeftAlt,
                                                                                               0,                 0,    KEY_Home,
                                                                             KEY_DeleteBackspace, KEY_DeleteForward,     KEY_End,
...
KB_MATRIX_LAYER(
  ...
  KEY_z_Z, KEY_z_Z, KEY_z_Z,       KEY_z_Z,        KEY_z_Z,     KEY_z_Z, 1,
  KEY_z_Z, KEY_z_Z, KEY_z_Z,       KEY_z_Z,        KEY_z_Z,     KEY_z_Z,
  KEY_z_Z, KEY_z_Z, KEY_z_Z,       KEY_z_Z,        KEY_z_Z,     KEY_z_Z, 2,
  KEY_z_Z, KEY_z_Z, KEY_LeftArrow, KEY_RightArrow, KEY_LeftGUI,
                                              KEY_LeftControl, KEY_LeftAlt,
                                         0,                 0,    KEY_Home,
                       KEY_DeleteBackspace, KEY_DeleteForward,     KEY_End,
  // right hand
  ...
  KEY_z_Z, KEY_z_Z, KEY_z_Z,      KEY_z_Z,     KEY_z_Z,       KEY_z_Z,
  KEY_z_Z, KEY_z_Z, KEY_z_Z,      KEY_z_Z,     KEY_z_Z,       KEY_z_Z, KEY_z_Z,
                    KEY_RightGUI, KEY_UpArrow, KEY_DownArrow, KEY_z_Z, KEY_z_Z,
  KEY_LeftAlt,  KEY_LeftControl,
  KEY_PageUp,   0,               0,
  KEY_PageDown, KEY_ReturnEnter, KEY_Spacebar
),
...
KB_MATRIX_LAYER(
  ...
  KEY_w_W, KEY_w_W, KEY_w_W,       KEY_w_W,        KEY_w_W,     KEY_w_W, 1,
  KEY_w_W, KEY_w_W, KEY_w_W,       KEY_w_W,        KEY_w_W,     KEY_w_W,
  KEY_w_W, KEY_w_W, KEY_w_W,       KEY_w_W,        KEY_w_W,     KEY_w_W, 2,
  KEY_w_W, KEY_w_W, KEY_LeftArrow, KEY_RightArrow, KEY_LeftGUI,
                                              KEY_LeftControl, KEY_LeftAlt,
                                         0,                 0,    KEY_Home,
                       KEY_DeleteBackspace, KEY_DeleteForward,     KEY_End,
  // right hand
  ...
  KEY_w_W, KEY_w_W, KEY_w_W,      KEY_w_W,     KEY_w_W,       KEY_w_W,
  KEY_w_W, KEY_w_W, KEY_w_W,      KEY_w_W,     KEY_w_W,       KEY_w_W, KEY_w_W,
                    KEY_RightGUI, KEY_UpArrow, KEY_DownArrow, KEY_w_W, KEY_w_W,
  KEY_LeftAlt,  KEY_LeftControl,
  KEY_PageUp,   0,               0,
  KEY_PageDown, KEY_ReturnEnter, KEY_Spacebar
),
...
KB_MATRIX_LAYER(
  ...
  KEY_s_S, KEY_s_S, KEY_s_S,       KEY_s_S,        KEY_s_S,     KEY_s_S, 1,
  KEY_s_S, KEY_s_S, KEY_s_S,       KEY_s_S,        KEY_s_S,     KEY_s_S,
  KEY_s_S, KEY_s_S, KEY_s_S,       KEY_s_S,        KEY_s_S,     KEY_s_S, 2,
  KEY_s_S, KEY_s_S, KEY_LeftArrow, KEY_RightArrow, KEY_LeftGUI,
                                              KEY_LeftControl, KEY_LeftAlt,
                                         0,                 0,    KEY_Home,
                       KEY_DeleteBackspace, KEY_DeleteForward,     KEY_End,
  // right hand
  ...
  KEY_s_S, KEY_s_S, KEY_s_S,      KEY_s_S,     KEY_s_S,       KEY_s_S,
  KEY_s_S, KEY_s_S, KEY_s_S,      KEY_s_S,     KEY_s_S,       KEY_s_S, KEY_s_S,
                    KEY_RightGUI, KEY_UpArrow, KEY_DownArrow, KEY_s_S, KEY_s_S,
  KEY_LeftAlt,  KEY_LeftControl,
  KEY_PageUp,   0,               0,
  KEY_PageDown, KEY_ReturnEnter, KEY_Spacebar
...
KB_MATRIX_LAYER(
  ...
  NULL,
  // left hand
  dbtldr, kprrel, kprrel, kprrel, kprrel, kprrel, lpop,
  kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, lpush1,
  kprrel, kprrel, kprrel, kprrel, kprrel, kprrel,
  kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, lpush2,
...
KB_MATRIX_LAYER(
  ...
  NULL,
  // left hand
  lpush3, kprrel, kprrel, kprrel, kprrel, kprrel, lpop,
  lpush4, kprrel, kprrel, kprrel, kprrel, kprrel, lpush1,
  lpush5, kprrel, kprrel, kprrel, kprrel, kprrel,
  lpush6, kprrel, kprrel, kprrel, kprrel, kprrel, lpush2,
  kprrel, kprrel, kprrel, kprrel, kprrel,
  kprrel, kprrel,
  NULL, NULL, kprrel,
  kprrel, kprrel, kprrel,
